...
SOURCE_INDEX            = 0
#############################################################################################################################
_factoid_qa_generate_both_ = False
qa_loss_domain_0_alpha     = 0     # original task loss in the base model for source domain example-2
...
output_model_dir              = output_dir+in_domain_names[1]+'/ansLen-200/'
trained_model_name            = ''
#############################################################################################################################
no_cuda = False
device = "cuda:2"
...
validation_batch_size = 64 #200 #64
weight_decay  = 0.0
adam_epsilon  = 1e-8
