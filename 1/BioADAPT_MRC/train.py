...
#     no_decay = []
    ...
    fieldnames      = [f'sample_{i}' for i in range(10570)]
...
#         writer1.writeheader()
    ...
    #             val_loss, squad_em, squad_f1 = validation_loss(model, tokenizer)
...
#                     exit(1)
                ...
                if ite > 5:
                    if (test_em_list.index(max(test_em_list))==ite
                        or test_f1_list.index(max(test_f1_list))==ite):
